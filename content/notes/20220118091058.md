...
lastmod = 2022-10-13T14:58:43+09:00
tags = ["WIKI", "Clojure"]
draft = false
+++
...
いわゆるPub/Subパターン. core.asyncのchannelのデフォルトの挙動はproducer-comsumerパターンなので, [💡Pub/SubパターンとProd/Consパターンの違い]({{< relref "20221008220000.md#a4997d2e-3c93-462a-90dc-37eab14f961b" >}})を意識したい. pub/subメソッドよって機能拡張するイメージ.
...
### 💡性能のボトルネックがCPUバウンドかIOバウンドか {#091437}
...
わたしの拙い記憶だと, 非同期処理をJava やPythonでうまく処理するには, 同期キューを用いた[Producer-Consumer Pattern]({{< relref "20221008220000.md#1e0ae462-5cdf-45d2-82de-ef3587583ff1" >}})をつかうのが鉄板だが, それをcore.asyncをつかうことによってかんたんに実装できる(素晴らしい).
...
### 🤔core.asyncにおける登場人物はループするなにか {#23410d}
...
-   [📝Clojure: Manifold]({{< relref "20220116191927.md#07f0fd0d-e6e0-4be1-b9bf-8b0fc7d74723" >}})
