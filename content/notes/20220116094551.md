...
lastmod = 2022-11-02T18:58:33+09:00
tags = ["Clojure", "WIKI"]
draft = false
+++
...
### Clojure: 多重定義関数(Multi-arity Functions) {#0a85be93-a9cb-4f70-a5f2-5bf209a45d32}
...
### Clojure: 可変長引数関数(Variadic Arity Functions) {#11aa1008-04ee-4554-9ebd-67470c0fc93f}

[可変長引数]({{< relref "20220305075933.md#e180be51-784e-4e9d-ba21-5c0e172b8918" >}})(オプション引数)をサポートする関数, variadic = 可変長.
...
[core.match]({{< relref "20220116081924.md#ac013f96-f828-4f63-9394-7318bcb5ebc4" >}})の形式で条件を [Multi-arity Functions](#0a85be93-a9cb-4f70-a5f2-5bf209a45d32) の形式で処理を記述することができる.
...
引数リストというところがミソ. applyは & をつかった[Clojure: 可変長引数関数](#11aa1008-04ee-4554-9ebd-67470c0fc93f)での活用を想定している.
...
-   refs.
    -   [🤔applyとは non-macro版のunquote-splicing?]({{< relref "20220302111024.md#a2c69b2f-1e8f-4a1c-bae6-81c616731e2c" >}})
-   links:
    -   [Clojure - Clojureを学ぼう - 関数](https://japan-clojurians.github.io/clojure-site-ja/guides/learn/functions#_%E9%96%A2%E6%95%B0%E3%82%92%E9%81%A9%E7%94%A8%E3%81%99%E3%82%8B)
