+++
title = "📝ステートマシン(FSM)"
lastmod = 2022-10-30T17:11:43+09:00
draft = false
+++
...
あるstateから別のstateに映ること. その遷移のトリガーをeventという.
...
オブジェクト指向におけるクラスの概念からの類推で捉えるとわかりやすいかもしれない. クラスとはデータと操作をドメインの単位で集めたもの. eeeeee
...
-   [ember-statecharts](https://ember-statecharts.com/)
    -   Webフレームワークember.jsにstatechartsを組み込む.
