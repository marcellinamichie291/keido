...
## <span class="org-todo todo _">💡</span> Howto {#6a7fe1}
...
### <span class="org-todo todo _">💡</span> protocolの第一引数thisとは対象の抽象データの操作を指す {#7e22e27f-d7a2-4780-a8d5-9a4887e990db}

考察続き.

ref. [一つのRecord固有の操作は関数/複数のRecordに共通の操作はprotocol](#6d1b0bad-8fda-4ab7-ae28-2a8fa72b3624)
