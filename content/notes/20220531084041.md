...
lastmod = 2022-09-24T18:21:21+09:00
tags = ["Clojure", "WIKI"]
draft = false
+++
...
### <span class="org-todo todo _">💡</span> integrantで状態を保持したいならdef/alter-var-root {#f4ea65}
...
### <span class="org-todo todo _">💡</span> なぜintegrantをつかうのか? {#ce2a49}
