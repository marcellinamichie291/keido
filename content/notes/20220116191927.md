...
lastmod = 2022-10-13T15:09:44+09:00
tags = ["WIKI"]
draft = false
+++
...
### 📝Clojure: Manifold {#07f0fd0d-e6e0-4be1-b9bf-8b0fc7d74723}
...
ManifoldのStreamを利用して作られた通信ライブラリが[aleph]({{< relref "20220209102028.md#f9f86e8c-b69a-43b8-8631-64ea7c9e48e8" >}}).


#### ⚖core.asyncとの比較 {#9388c9}

cf. [📝Clojure core.async]({{< relref "20220118091058.md" >}})
...
core.asyncとmanifoldは同じことができる. manifoldのlet-flow/go-offがgoに相当.

<https://aleph.io/manifold/deferreds.html>


#### 🤔先行きのメンテナンス状況が不安 {#c196f7}
