+++
title = "📝並行プログラミング"
lastmod = 2022-10-12T19:16:49+09:00
tags = ["WIKI", "TAG"]
draft = false
+++
...
生産者と消費者が1対1の場合は **Pipe パターン** ということもある.
...
#### 💡Pub/SubパターンとProd/Consパターンの違い {#f8a8a1}

どちらもスレッド同士がメッセージをやり取りするという点で同じであり似ている. しかし別の概念.
