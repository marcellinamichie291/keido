+++
title = "📝並行プログラミング"
lastmod = 2022-10-08T08:32:01+09:00
tags = ["WIKI", "TAG"]
draft = false
+++
...
Concurrency Programming, 並行および並列プログラミングについて.
...
平行は数学のコンテキストでよくつかう. 並行はプログラミングのコンテキストでよくつかう.

---

さらに紛らわしいのは平行の一般的な英訳はparallelであるが, プログラミングの世界においてparallelとは並列を指す.

並行はConcurrent, ともに(con)走る(cur).


### 💡並行処理と並列処理の違いは？ {#908d6081-63c6-4abf-b0b0-3e2a6dd4f01f}
