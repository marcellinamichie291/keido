...
lastmod = 2022-09-09T05:55:36+09:00
tags = ["WIKI"]
draft = false
+++
...
## if/when/cond/case {#5fa933}

条件分岐の複雑さを解くための抽象が必要かどうかをまず見極める. 必要がなければif/cond/caseあたりのより簡単なシンタックスで済ます.

ref. [Clojure Flow Basic Syntax(if/when/cond/case)]({{< relref "20220116083656.md#02a52f53-0077-43b8-ba74-098c44004e17" >}})
