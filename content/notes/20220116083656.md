+++
title = "📝Clojure Flows"
lastmod = 2022-10-19T12:21:38+09:00
tags = ["WIKI"]
draft = false
+++
...
### スレッディングマクロをmacroexpandする {#c3f926}

スレッディングマクロはマクロであるため, マクロ展開の関数である[macroexpand]({{< relref "20220302111024.md#bd555087-a0e5-4b23-a11d-9d746f573b08" >}})を利用すると, 実際にどういうように評価されるのかを確認することができ, デバッグ作業を助ける.
