+++
title = "📝マーケットメイク"
lastmod = 2022-09-19T20:17:52+09:00
tags = ["WIKI"]
draft = false
+++
...
基本的なマーケットメイクは仲値の両側に均等にmarginを取って差分を入れるが, この論文の提案は在庫リスクを低減するためにトレンド方向を考慮してちょっとずらして指値を入れる.

---

[Optimal High-Frequency Market Making[2018](http://stanford.edu/class/msande448/2018/Final/Reports/gr5.pdf)では, 実装とパラメータ調整の追加分析をしている.
