+++
title = "📝マーケットメイク"
lastmod = 2022-10-02T15:44:42+09:00
tags = ["WIKI"]
draft = false
+++
...
トレンドの判定には[📍高頻度取引戦略: 情報モデル]({{< relref "20220916104417.md#9ead5e99-54ce-460a-ad4d-ad08448caa1c" >}})の偏りを利用(流動性や約定履歴など).
