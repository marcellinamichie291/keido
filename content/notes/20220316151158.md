...
lastmod = 2022-09-02T19:59:13+09:00
tags = ["WIKI"]
draft = false
+++
...
### <span class="org-todo todo _">✅</span> 定義へジャンプする(cider-find-var/cider-pop-back) {#552131}
...
### <span class="org-todo todo _">✅</span> namespaceから定義を取り除く(cider-undef) {#54e87b}
...
### tips: 関数の定義を参照する(Find References) {#13ffd3}
...
### tips: cider-clojuredocsの活用 {#782615}
