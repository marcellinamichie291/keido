+++
title = "📝デザインパターン"
lastmod = 2022-10-29T17:55:16+09:00
tags = ["WIKI"]
draft = false
+++
...
### Observer Pattern {#656f1e13-29cb-4038-86df-1c1183ece202}
...
[⚙Publisher-Subscriberパターン]({{< relref "20220116195030.md#0b8b761b-2fb9-48f1-9777-cc09e92bed6c" >}})ともいわれるが, いわれているだけで別ものな気もする. Pub/SubパターンはProd/Consパターンの部分であり並行プログラミングに関わる.


### ステートパターン - State Pattern {#aa38e457-ae0f-421a-a7e6-a0c95163b3cb}
...
see also. [📝状態管理概論]({{< relref "20221029173301.md" >}})
...
-   [💡マクロとは広義のデザインパターンでありパターンの自動化]({{< relref "20221022212013.md#9f346eca-562f-4f88-a283-513cb8613612" >}})
