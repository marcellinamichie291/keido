+++
title = "📝仮想通貨bot開発"
lastmod = 2022-10-23T10:15:39+09:00
tags = ["WIKI"]
draft = false
+++
...
[まちゅけん]({{< relref "20220712161715.md#4fcb1fe2-7201-40e3-a81b-50fd3e7e0bce" >}})さん作成. REST通信とwebsocketの両方のIFを提供.
...
並行プログラミングのテクニックが学べる. pybotttersだけだと, 情報の受信まではできるがその先の並行プログラミングがどうやればいいのか混乱する.
...
[📚Java言語で学ぶデザインパターン入門マルチスレッド編 - 結城浩]({{< relref "20221008165448.md#9a93cf27-b197-47bf-80df-088a0bd2992b" >}})
